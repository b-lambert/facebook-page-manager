...
var PaginateButton = React.createClass({
  render: function(){
    if (this.props.next_page !== undefined && this.props.next_page.length > 0) {
      return(
...
var PostBox = React.createClass({
  ...
  getInitialState: function() {
    return {error: "", is_loading: true, data: [], access_token: "EAACo3Ko02MUBAIGgtEBQulP63K63QpL0VS6VY5fSbtjZCx8jouPGlkZBPMMTd4LEluv3HS0YJi6Q9WRweZA4zxrrZAoa5MRBoZAaPZC1JXYGLicUYmWDV9KiblcvZC3IKEPeM0PQYbvi8stlIsFzpBERJlzS8qRnzKBaZA9oqfkZAuwZDZD"};
  },
        ...
        <div className="card">
          <form className="postForm" onSubmit={this.handleSubmit}>
            ...
            <div className="card-action">
              <input className="btn indigo darken-4" type="submit" value="Create Post" />
            </div>
          </form>
        </div>
      );
